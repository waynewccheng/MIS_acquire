classdef LightSim < handle
    ...
    methods
        ...
        function obj = LightSim
            ...
            load('col_spec','col_spec')
            obj.col_spec = col_spec;
        end
        
        function do_spike (obj)
            load('spike_0531.mat','spike_black','spike_white','spike_spike')
            
            clf
            hold on
            for i = 1:50
                
                spd_white = spike_white{i}.amplitude;
                spd_spike = spike_spike{i}.amplitude;
                spd_black = spike_black.amplitude;
                
                reflectance{i} = (spd_spike - spd_black) ./ (spd_white - spd_black);
                plot(reflectance{i})
            end
